...
final class NotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    func scheduleWaterReminder(plantName: String, intervalHours: Int) {
        let content = UNMutableNotificationContent()
        content.title = "🌿 \(plantName)渴了"
        content.body = "快来给\(plantName)浇水吧！它看起来有点干。"
    ...
    func sendEvolutionCelebration(plantName: String, newStage: String) {
        ...
        content.body = "恭喜！\(plantName)成长到了「\(newStage)」阶段！快来看看吧！"
        content.sound = .default
